...
def main():
    ...
    parser.add_argument("--d-ff-multiplier", type=float, default=3.0, help="Transformer feedforward multiplier")
    parser.add_argument("--transformer-dropout", type=float, default=0.1, help="Transformer dropout")
